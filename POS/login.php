...
<head>
    ...
    <title>LOGIN | Simple Cashiering System</title>
...
<body>
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h2 class="py-5 text-center">Drugstore POS and <br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Inventory System</h2>
